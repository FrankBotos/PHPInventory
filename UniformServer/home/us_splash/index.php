...
<title>Uniform Server ZeroXII - Splash page</title>
<meta name="Description" content="The Uniform Server ZeroXII 12.0.0" />
<meta name="Keywords" content="The Uniform Server,ZerXII,MPG,Mike,Ric,UniServer,Olajide,BobS " />
...
<div id="wrap">
  <div id="header">
     ...
     <a href="http://www.uniformserver.com"><img src="images/logo.png" align="left" alt="The Uniform Server ZeroXII" /></a>
       <div id="header_txt2" >
         <div style="position:absolute;">
           <b>ZeroXII <?php print "- ".$version; ?> </b><br />
           Apache 2.4.20 VC14 <br />
           MySQL 5.6.29 <br />
  ...
  <div id="content">
    ...
    <p>Welcome to The Uniform Server ZeroXII default start splash page. This page and every other file are being served by Apache. Information can be found in folder UniServer\docs. Additional support for ZeroXII see <a target="_1" href="http://www.uniformserver.com/ZeroXII_documentation/">on-line documentation</a>.</p>
    <p>&nbsp;</p>
  ...
  <table>
   ...
   <td>
    <ul>
      <li> Apache 2.4.20 VC14 openssl 1.0.2g</li>
      <li> MySQL 5.5.48-community</li>
      <li> MySQL 5.6.29-community</li>
      <li> Mariadb 5.5.48 </li>
      <li> Mariadb 10.0.24 </li>
      <li> PHP : 5.3.29</li>
      <li> PHP : 5.4.45</li>
      <li> PHP : 5.5.34</li>
      <li> PHP : 5.6.20</li>
      <li> PHP : 7.0.5</li>
      <li> phpMyAdmin 4.4.15.5</li>
      <li> phpMyAdmin 4.6.0</li>
